                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>1010531</td>
                                <td>SAMSONITE SIN</td>
                                <td class="text-end">87,500.00</td>
                                <td class="text-end">2,500.00</td>
                                <td>USD</td>
                                <td class="text-end">35.00</td>
                                <td>2/1/2011015032_003</td>
                                <td></td>
                                <td></td>
                                <td>Map_Actual_Done</td>
                                <td>Chasin P.</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-end">26,566.75</td>
                                <td class="text-end">759.00</td>
                                <td>USD</td>
                            ...
                            <tr>
                                ...
                                <td>1010531</td>
                                <td>SAMSONITE SIN</td>
                                <td class="text-end">49,875.00</td>
