...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            ...
            <div class="table-container">
                <div class="table-responsive bms-data-table-scroll" tabindex="0" role="region" aria-label="Draft PO results">
    ...
    <script>
        ...
        let exportTXN = function () {
            ...
            BMSLoading.download('Handler/DataPOHandler.ashx?' + params.toString(), 'Exporting Draft PO...', 'Preparing Excel file');
        }
