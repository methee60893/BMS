...
<div class="sidebar" id="sidebar">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-area">
            ...
            <div class="detail-box">
                    ...
                    <div class="detail-row">
                        <div class="detail-label">Total Actual + Draft PO</div>
                        <div class="detail-value" id="detail_TotalPO_Usage">0.00 THB</div>
                    </div>
    ...
    <script>
        ...
        let search = function () {
            ...
            // Show loading state
            BMSLoading.show('Loading OTB Remaining...', 'Please wait');
            // Clear detail box
        ...
        let exportOTBMovement = function () {
            ...
            BMSLoading.download('Handler/DataOTBHandler.ashx?' + params.toString(), 'Exporting OTB Movement...', 'Preparing Excel file');
        }
        ...
        let exportCategorySum = function () {
            ...
            BMSLoading.download('Handler/DataOTBHandler.ashx?' + params.toString(), 'Exporting OTB Summary...', 'Preparing Excel file');
        }
