...
BEGIN
    ...
    (
        ...
        BMS_Last_Synced datetime NOT NULL,
        CONSTRAINT PK_Actual_PO_Staging PRIMARY KEY CLUSTERED
        (
            PO, PO_Item, Otb_Year, Otb_Month, Company_Code,
            Supplier, Fund, Category, Brand
        )
    );
END;
GO
...
BEGIN
    ...
    (
        ActualPO_ID int IDENTITY(1,1) NOT NULL,
        ...
        Category_Code nvarchar(20) NOT NULL,
        Segment_Code nvarchar(20) NOT NULL,
        Clean_Segment nvarchar(20) NULL,
        ...
        Status_By nvarchar(100) NULL,
        Draft_PO_ID_Ref int NULL,
        Draft_PO_Ref nvarchar(100) NULL,
        Remark nvarchar(500) NULL,
        Created_By nvarchar(100) NOT NULL,
        Created_Date datetime NOT NULL CONSTRAINT DF_Actual_PO_Summary_CreatedDate DEFAULT (getdate()),
        Matching_Date datetime NULL,
