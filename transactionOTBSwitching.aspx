...
<div class="sidebar" id="sidebar">
        ...
        <li class="menu-item" id="grpmenuOTBSwitching" runat="server">
            ...
            <ul class="submenu" id="otbSwitching">
               <li id="menuCreateOTBSwitching" runat="server" ><a href="createOTBswitching.aspx" class="menu-link">Create OTB Switching</a></li>
                <li id="menuSwitchingTransaction" runat="server" ><a href="transactionOTBSwitching.aspx" class="menu-link active">Switching Transaction</a></li>
            </ul>
        </li>
    ...
    <script>
        ...
        let search = function () {
            ...
            BMSLoading.show('Loading Switching Transaction...', 'Please wait');
        ...
        let exportTXN = function () {
            ...
            BMSLoading.download('Handler/DataOTBHandler.ashx?' + params.toString(), 'Exporting Switching Transaction...', 'Preparing Excel file');
        }
